...
// «دسته‌بندی و قیمت‌ها» عمداً از این لیست حذف شد (فاز ۱۴): قابلیت مشابهش
// («ضایعاتت چقدر می‌ارزه؟») از قبل بالاتر همین صفحه با کارت پررنگ‌تری وجود
// دارد، پس تکراری بود. مسیر /materials همچنان از طریق آن کارت
// («مشاهده همه» بالای «قیمت روز ضایعات») در دسترس است.
const SERVICES = [
