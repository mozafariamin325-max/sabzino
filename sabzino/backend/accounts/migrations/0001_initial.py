    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
                ("title", models.CharField(default="آدرس من", max_length=64)),
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("CITIZEN", "شهروند"),
                            ("COLLECTOR", "جمع\u200cآور"),
                            ("STATION_OPERATOR", "اپراتور ایستگاه"),
                            ("RECYCLING_CENTER", "مرکز بازیافت"),
                            ("WHOLESALER", "خریدار عمده"),
                            ("FACTORY", "کارخانه"),
                            ("BUSINESS", "کسب\u200cوکار"),
                            ("SCHOOL", "مدرسه"),
                            ("APARTMENT_MANAGER", "مدیر مجتمع"),
                        ],
                        max_length=32,
                    ),
                ),
