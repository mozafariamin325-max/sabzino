                              ...
                              <div className="mt-3 pt-3 border-t border-brand-100">
                                ...
                                {items[m.id].isExact ? (
                                  <input
                                    ...
                                    onChange={(e) => updateItem(m.id, { weightKg: Math.max(0.1, Number(e.target.value)) })}
                                  />
                                ) : (
          ...
          <div className="flex flex-col gap-4">
            ...
            {scheduleMode === "ONCE" ? (
              ...
              <div className="flex flex-col gap-3">
                ...
                <div>
                  <label className="text-xs text-ink-500 mb-1 block">ساعت تقریبی مراجعه</label>
                  <input
                    type="number" min={6} max={22}
                    className="w-full rounded-xl border border-brand-100 p-3 text-sm"
                    value={preferredHour}
