...
class Command(BaseCommand):
    ...
    def seed_materials(self):
        data = {
            "پلاستیک": [("پلاستیک سخت", 8000, 0.5), ("پت (PET)", 12000, 0.6)],
            "کاغذ و مقوا": [("کارتن", 4000, 0.3), ("کاغذ اداری", 3500, 0.3)],
            "فلزات": [("آهن", 9000, 0.8), ("آلومینیوم", 35000, 1.2), ("مس", 180000, 1.5)],
            "شیشه": [("شیشه شکسته", 1500, 0.2)],
            "الکترونیک": [("لوازم الکترونیکی مجاز", 15000, 0.4)],
        }
        icons = {"پلاستیک": "♻️", "کاغذ و مقوا": "📦", "فلزات": "🔩", "شیشه": "🍾", "الکترونیک": "🔌"}
        categories = {}
