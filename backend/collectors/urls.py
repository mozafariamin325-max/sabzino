...
from .views import (
    CollectorRegisterView, MyCollectorProfileView, ToggleOnlineView, NearbyCollectorsView, CollectorTodayStatsView,
...
urlpatterns = [
    ...
    path("me/today-stats/", CollectorTodayStatsView.as_view(), name="collector-today-stats"),
